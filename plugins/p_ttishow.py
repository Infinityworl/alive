...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('🟢 ɪɴꜰɪɴɪᴛʏ ᴍᴏᴠɪᴇꜱ 🟢', url=f'https://t.me/sinhalafilx'),
            ],[
               InlineKeyboardButton('🟢 ᴛᴠ ꜱᴇʀɪᴇꜱ ᴄʜᴀɴɴᴇʟ 🟢', url=f'https://t.me/infinitytvseries'),
            ],[
               InlineKeyboardButton('🟢 ꜱɪɴʜᴀʟᴀ ᴅᴜʙʙᴇᴅ  🟢', url=f'https://t.me/sinhalaLk')
            ]] 
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
                  InlineKeyboardButton("🟢 ɪɴꜰɪɴɪᴛʏ ᴍᴏᴠɪᴇꜱ 🟢", url="https://t.me/sinhalafilx"),
                  ],[
                  InlineKeyboardButton("🟢 ᴛᴠ ꜱᴇʀɪᴇꜱ ᴄʜᴀɴɴᴇʟ 🟢", url="https://t.me/infinitytvseries"),
                  ],[
                  InlineKeyboardButton("🟢 ꜱɪɴʜᴀʟᴀ ᴅᴜʙʙᴇᴅ  🟢", url="https://t.me/sinhalaLk")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
