...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('♂️ ɪɴꜰɪɴɪᴛʏ ᴍᴏᴠɪᴇꜱ ♂️', url="https://t.me/sinhalafilx"),
                ],[
                    InlineKeyboardButton('📍 ᴛᴠ ꜱᴇʀɪᴇꜱ ᴄʜᴀɴɴᴇʟ 📍', url='https://t.me/infinitytvseries')
                 ]]
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('✨️ ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ ✨️', url=f'https://t.me/sinhalafilx') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
    ...
    if data.startswith("sendfiles"):
        ...
        k = await client.send_message(chat_id=message.from_user.id,text=f"🫂 ʜᴇʏ {message.from_user.mention}, {gtxt}\n\n‼️ ɢᴇᴛ ᴀʟʟ ꜰɪʟᴇꜱ ɪɴ ᴀ ꜱɪɴɢʟᴇ ʟɪɴᴋ ‼️\n\n✅ ʏᴏᴜʀ ʟɪɴᴋ ɪꜱ ʀᴇᴀᴅʏ, ᴋɪɴᴅʟʏ ᴄʟɪᴄᴋ ᴏɴ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ.\n\n", reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton('✨ ʙᴜʏ ꜱᴜʙꜱᴄʀɪᴘᴛɪᴏɴ ꜰᴏʀ ᴘʀᴇᴍɪᴜᴍ ✨', callback_data="seeplans")                        
                    ]
                ]
            )
        )
        ...
        for file in files:
            ...
            filesarr.append(msg)
        k = await client.send_sticker(sticker="CAACAgIAAx0CdbtO-QACByhlvUbTOqRIqX8yhA5o8J_XPD0nqAACegEAAiI3jgR80USR9hGNuB4E")
        await asyncio.sleep(600)
        for x in filesarr:
            await x.delete()
        await k.edit_sticker(sticker="CAACAgIAAx0CdbtO-QACByhlvUbTOqRIqX8yhA5o8J_XPD0nqAACegEAAiI3jgR80USR9hGNuB4E")
        return    
    ...
    if not files_:
        ...
        try:
            ...
            k = await msg.reply(sticker="CAACAgIAAx0CdbtO-QACByhlvUbTOqRIqX8yhA5o8J_XPD0nqAACegEAAiI3jgR80USR9hGNuB4E",quote=True)
            await asyncio.sleep(600)
            await msg.delete()
...
async def settutorial(bot, message):
    ...
    if len(message.command) == 1:
        ...
        return await message.reply("<b>ʏᴏᴜ ᴇɴᴛᴇʀᴇᴅ ɪɴᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ !\nᴄᴏʀʀᴇᴄᴛ ꜰᴏʀᴍᴀᴛ : /set_tutorial <code>https://t.me/sinhalafilx</code></b>")
