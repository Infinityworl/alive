...
3) ᴍᴏᴠɪᴇ ɪs ɴᴏᴛ ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ ᴛʜᴇ ᴅᴀᴛᴀʙᴀsᴇ ʀᴇᴘᴏʀᴛ ᴛᴏ ᴀᴅᴍɪɴs @infinityworldlk</b>"""
...
🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/nimsar_a'>ʜᴘ</a></b>"""
...
• /restart - <code>ʀᴇꜱᴛᴀʀᴛ ᴛʜᴇ ʙᴏᴛ.</code>"""
    ...
    SHORTLINK_INFO = """<b>
 ❗<u> ʜᴏᴡ ᴛᴏ ᴜꜱᴇ ɪɴꜰɪɴɪᴛʏ ʙᴏᴛ </u>❗

🔴 ꜰɪʀꜱᴛ ꜱᴛᴀʀᴛ ɪɴꜰɪɴɪᴛʏ ʙᴏᴛ 🔴 ɴᴏᴡ ᴀᴅᴅ ʙᴏᴛ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ʜɪᴛ ᴛʜᴇ ꜱᴛᴀʀᴛ ʙᴜᴛᴛᴏɴ  !

›› ꜱᴛᴇᴘ 1 : ᴀᴅᴅ ᴛʜɪꜱ ʙᴏᴛ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀꜱ ᴀɴ ᴀᴅᴍɪɴ...

›› ꜱᴛᴇᴘ 2 : ᴜꜱᴇ /connect ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ ᴄᴏɴɴᴇᴄᴛ ʙᴏᴛ ᴛᴏ ʏᴏᴜʀ ᴘᴍ.

›› ꜱᴛᴇᴘ 3 : ᴄʟɪᴄᴋ ᴏɴ ɴᴇxᴛ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴋɴᴏᴡ ʜᴏᴡ ᴛᴏ ᴄᴏɴɴᴇᴄᴛ  ᴛʜɪs ʙᴏᴛ.

🔴 ᴅᴏɴ'ᴛ ᴡᴀɪᴛ ᴀɴʏ ʟᴏɴɢᴇʀ ᴛᴏ ꜰɪɴᴅ ᴍᴏᴠɪᴇꜱ ꜰʀᴏᴍ ʏᴏᴜʀ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴘ. ᴀᴅᴅ ᴏᴜʀ ʙᴏᴛ ᴛᴏᴅᴀʏ ᴀɴᴅ ꜱᴛᴀʀᴛ ꜰɪɴᴅ ᴍᴏᴠɪᴇꜱ 🔴! </b>
"""

    SHORTLINK_INFO2 = """<b>
❗<u> ꜱɪɴʜᴀʟᴀ ʟᴀɴɢᴜᴀɢᴇꜱ ᴛᴜᴛᴏʀɪᴀʟ </u>❗

›› ꜱᴛᴇᴘ 1 : හායි කොහොමද ඔයලාට මේ තියෙන්න් අපේ බොට්ව පාවිච්චි කරන හැටි.

›› ꜱᴛᴇᴘ 2 : මුලින්ම අපේ බොට් ඔයාලගේ group එකට ඇඩ් කරන්න දැන් බොට්ව මෙහෙම /connect කරන්න.

› ʟɪᴋᴇ ᴛʜɪꜱ :</b>  <code>දැන් /settings කියලා මෙහෙම command එක දෙන්න ඉට පස්සේ shortlink disable කරන්න</code>

<b>›› ꜱᴛᴇᴘ 3 : congratulations දැන් ඔයාලාට ඔනි ෆිල්ම් එකක් tv series එකක් හොයාගන්න පුලුවන් .
...
★ ඔයාලට අපේ botgen premium membership එකක් buy කරන්න පුලුවන් එක වාසි ගැන දැනගන්න buy premium click කරන්න.</b>
"""
...
""" 
   # PLEASE DO NOT REMOVE ANY CREDITS ❤️‍🩹
    ...
    CAPTION = """ 📂 <i><a href="https://telegram.me/sinhalafilx">{file_name}</a></i>\n\n"""
...
💵  ɪᴅ - <code>nimsar_a</code>
📸 ǫʀ ᴄᴏᴅᴇ - <a href='https://graph.org/file/e55213508bd93141ffaaf.jpg'>ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ꜱᴄᴀɴ</a>
